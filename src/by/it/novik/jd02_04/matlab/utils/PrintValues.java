...
import by.it.novik.jd01_13.matlab.utils.*;
...
public class PrintValues {
    ...
    public static void printVars () {
        Map<String,Variable> mapVar = by.it.novik.jd01_13.matlab.utils.MapValues.getInstance();
        if (!mapVar.isEmpty()) {
    ...
    public static void sortVars () {
        Map<String,Variable> mapVar = new TreeMap<>(by.it.novik.jd01_13.matlab.utils.MapValues.getInstance());
        if (!mapVar.isEmpty()) {
