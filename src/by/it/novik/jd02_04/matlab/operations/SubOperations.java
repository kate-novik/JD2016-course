 ...
 */
public class SubOperations implements by.it.novik.jd01_13.matlab.operations.ISubtraction {
    ...
    private MatrixValue subtraction(DoubleValue value1, MatrixValue value2) throws ErrorOperationsException {
        return (MatrixValue)new by.it.novik.jd01_13.matlab.operations.AddOperations().addition(value1, new MultiOperations().multiplication(new DoubleValue(-1), value2));
    }
